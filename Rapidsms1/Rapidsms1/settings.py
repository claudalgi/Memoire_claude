# Django settings for Rapidsms1 project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a Rapidsms1 directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'Rapidsms1')
...
SECRET_KEY = 'm)162vs2u1pbu@=ro55xhh#%5*k227ef3biqaxb-c@r^v=&6te'
...
ROOT_URLCONF = 'Rapidsms1.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Rapidsms1.wsgi.application'
